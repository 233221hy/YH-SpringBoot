...
@NoArgsConstructor
public class DiscussStudentExportVO {
    ...
    public static DiscussStudentExportVO fromResultSet(ResultSet rs) {
        try {
            DiscussStudentExportVO vo = new DiscussStudentExportVO();
            ...
            throw new RuntimeException("构建学生讨论统计导出VO失败", e);
        }
    }
}
